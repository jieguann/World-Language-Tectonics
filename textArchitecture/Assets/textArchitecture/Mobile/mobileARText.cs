...
//using MegaFiers;
public class mobileARText : MonoBehaviour
{   //text control
    ...
    */
    ...
    void Start()
    {
        ...
        textObject.transform.position = new Vector3(cameraObject.transform.position.x, 1, cameraObject.transform.position.z) + new Vector3(cameraObject.transform.forward.x * 6f,0, cameraObject.transform.forward.z * 6f);
        pVolume.weight = 0;

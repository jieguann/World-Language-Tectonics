...
//using MegaFiers;
public class cameraFeedVisulization : MonoBehaviour
{   //text control
    ...
    */
    ...
    void Update()
    {
        ...
        textObject.transform.localPosition = new Vector3(0, architectureScaleY, 0);
    ...
    void textVisualizer()
    {
        if (items != null)
        {
            ...
            for (int i = 0; i < resolution; i++)
            {
                ...
                {
                    textmeshPro.color = new Color32(0,0,5, 255);
                    assignLayer(9);
